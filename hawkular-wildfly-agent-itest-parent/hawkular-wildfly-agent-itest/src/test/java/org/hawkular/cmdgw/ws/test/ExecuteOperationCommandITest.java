...
public class ExecuteOperationCommandITest extends AbstractCommandITest {
    ...
    public void testExecuteOperation() throws Throwable {
        ...
        Resource deployment = getResource("/feeds/localhost/resourceTypes/Deployment/resources",
    ...
    public void testExecuteAgentDiscoveryScan() throws Throwable {
        ...
        AssertJUnit.assertEquals(1, wfs.size());
        CanonicalPath wfPath = wfs.get(0).getPath();
        Resource agent = getResource("/feeds/localhost/resourceTypes/Hawkular%20WildFly%20Agent/resources",
                (r -> r.getId() != null));
